...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Serie'
        db.create_table('ella_series_serie', (
            ...
            ('hide_newer_parts', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ...
        db.send_create_signal('ella_series', ['Serie'])

        # Adding model 'SeriePart'
        db.create_table('ella_series_seriepart', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('serie', self.gf('django.db.models.fields.related.ForeignKey')(related_name='serie_set', to=orm['ella_series.Serie'])),
            ('publishable', self.gf('django.db.models.fields.related.ForeignKey')(related_name='part_set', unique=True, to=orm['core.Publishable'])),
            ('part_no', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1)),
        ))
        db.send_create_signal('ella_series', ['SeriePart'])


    def backwards(self, orm):
        # Deleting model 'Serie'
        db.delete_table('ella_series_serie')

        # Deleting model 'SeriePart'
        db.delete_table('ella_series_seriepart')
